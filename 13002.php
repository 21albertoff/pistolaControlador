...
<body>
    <div class="container mt-5">
        ...
        $sql = "SELECT valor FROM datos WHERE centro LIKE '1300' AND tipo = '2' ORDER BY fecha_creacion DESC LIMIT 1";
        ...
        $conexion->close();
        ?>
        <form action="process13002.php" method="post">
            <input type="text" id="valor" name="valor" required>
            <input type="hidden" id="centro" name="centro" value="1300">
